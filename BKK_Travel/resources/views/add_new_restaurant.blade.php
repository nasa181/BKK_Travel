@extends('master')
@section('center_page')
    <form method="post" action="/page_travel/add_new_restaurant">
        ...
        <div class="row form-group">
            <div style="margin: 10px 20px 10px 20px"><label>Price range</label><input type="text" class="form-control" name="in_new_price_range" placeholder="Price.."></div>
        </div>
        <div class="row form-group">
            <div style="margin: 10px 20px 10px 20px"><label>Food Type</label><input type="text" class="form-control" name="in_new_food_type" placeholder="Thai food, Japanese food, ..."></div>
        </div>
        <div class="row form-group">
        ...
        <div class="row form-group">
            <div style="margin: 10px 20px 10px 20px"><label>Credit card</label><textarea rows="5" class="form-control" name="in_new_credit_card" placeholder="accept or not.."></div>
        </div>
        <div class="row form-group">
            <div style="margin: 10px 20px 10px 20px"><label>Child appropriate</label><textarea rows="5" class="form-control" name="in_new_child_appropriate" placeholder="Yes or No.."></div>
        </div>
        <div class="row form-group">
            <div style="margin: 10px 20px 10px 20px"><label>Reservable</label><textarea rows="5" class="form-control" name="in_new_reservable" placeholder="Yes or No.."></div>
        </div>
        <div class="row form-group">
