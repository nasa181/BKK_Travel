            ...
            @if(isset($current_user)&&( $current_user[4]=="Admin"||$current_user[5]==$item->user_id ))
                <div class="row">
                    <div class= "col-md-offset-10 col-md-2 col-xs-offset-8 col-xs-4"style="text-align: right">
                        <div><a href="#"><button class="form-control btn-warning btn">edit</button></a></div>
                    </div>
                </div>
            @endif
                ...
                <div class="col-md-6"  style="margin-bottom: 20px;" >
                    <div class="" style="padding: 40px 20px;border: dashed #D4EF4C;border-radius: 20px;/*background: rgba(212,239,76,0.2)*/;">
                        ...
                        <div class="shadow-text">
                            ...
                            <div class="row" style="">
                                <div class="col-xs-12" style="margin-bottom: 5px"><span>End Date :  {{$event->end_date}} </span></div>
                            </div>
                            <div class="row" style="">
                            ...
                            <div class="row" style="">
                                <div class="col-xs-12" style="margin-bottom: 5px"><span>Entrance Fee : {{$event->entrance_fee}}</span></div>
                            </div>
                            <div class="row" style="">
                                <div class="col-xs-12" style="margin-bottom: 5px"><span>Event type : {{$event->type}} </span></div>
                            </div>
                            <div class="row" style="">
                                <div class="col-xs-12" style="margin-bottom: 5px"><span>Parking : {{$event->parking}}</span></div>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-12 " style="์margin-bottom: 20px;"  >
                            <div id="address_box" class="image-size-2" style="border: dashed #FF6C6C;border-radius: 20px;/*background: rgba(205,108,108,0.2*/)">
                                <div class="shadow-text">
                                    ...
                                    <div class="row" style="">
                                        <div class="col-xs-12" style="margin-bottom: 5px"><span>Website : {{$event->website_url}}</span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
